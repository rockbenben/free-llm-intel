...
6. [克劳德的文本水印如何工作](https://www.anthropic.com/news/claude-text-watermark)（2026-08-14）
7. [改善《神鬼寓言 5》的生物防护](https://www.anthropic.com/news/improving-fable-5-s-biology-safeguards)（2026-08-07）
8. [马里亚诺-弗洛伦蒂诺（蒂诺）奎利亚尔将加入 Anthropic 担任首席全球事务官](https://www.anthropic.com/news/tino-cuellar)（2026-08-04）
9. [在我们的网络安全评估中调查三个现实事件](https://www.anthropic.com/news/investigating-incidents-cybersecurity-evals)（2026-07-30）
10. [我们对开放重量模型的立场](https://www.anthropic.com/news/position-open-weights-models)（2026-07-27）
11. [产品介绍 Claude Opus 5Opus 5 是 Opus 层的一项逐步变革改进，为长期运行的代理提供支持，同时提供编码和专业工作方面的改进。](https://www.anthropic.com/news/claude-opus-5)（2026-07-24）
12. [最近克劳德代码质量报告的更新](https://www.anthropic.com/engineering/april-23-postmortem)（2026-04-23）
13. [扩展托管代理：将大脑与双手分离](https://www.anthropic.com/engineering/managed-agents)（2026-04-08）
14. [我们如何构建克劳德代码自动模式：一种更安全的跳过权限的方法](https://www.anthropic.com/engineering/claude-code-auto-mode)（2026-03-25）
15. [用于长期运行的应用程序开发的线束设计](https://www.anthropic.com/engineering/harness-design-long-running-apps)（2026-03-24）
16. [Claude Opus 4.6 的 BrowseComp 性能中的评估意识](https://www.anthropic.com/engineering/eval-awareness-browsecomp)（2026-03-06）
17. [量化代理编码评估中的基础设施噪声](https://www.anthropic.com/engineering/infrastructure-noise)（2026-02-05）
18. [与并行的 Claudes 团队一起构建 C 编译器](https://www.anthropic.com/engineering/building-c-compiler)（2026-02-05）
19. [设计抗人工智能技术评估](https://www.anthropic.com/engineering/AI-resistant-technical-evaluations)（2026-01-21）
20. [揭秘人工智能代理的评估](https://www.anthropic.com/engineering/demystifying-evals-for-ai-agents)（2026-01-09）
21. [长期运行代理的有效利用](https://www.anthropic.com/engineering/effective-harnesses-for-long-running-agents)（2025-11-26）
22. [介绍 Claude 开发者平台上的高级工具使用](https://www.anthropic.com/engineering/advanced-tool-use)（2025-11-24）
23. [使用 MCP 执行代码：构建更高效的代理](https://www.anthropic.com/engineering/code-execution-with-mcp)（2025-11-04）
24. [超越权限提示：让 Claude Code 更加安全和自主](https://www.anthropic.com/engineering/claude-code-sandboxing)（2025-10-20）
25. [为现实世界的代理配备代理技能](https://www.anthropic.com/engineering/equipping-agents-for-the-real-world-with-agent-skills)（2025-10-16）
26. [人工智能代理的有效上下文工程](https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents)（2025-09-29）
27. [最近三个问题的事后分析](https://www.anthropic.com/engineering/a-postmortem-of-three-recent-issues)（2025-09-17）
28. [与代理一起为代理编写有效的工具](https://www.anthropic.com/engineering/writing-tools-for-agents)（2025-09-11）
29. [桌面扩展：Claude Desktop 的一键 MCP 服务器安装](https://www.anthropic.com/engineering/desktop-extensions)（2025-06-26）
30. [我们如何构建多主体研究系统](https://www.anthropic.com/engineering/multi-agent-research-system)（2025-06-13）
31. [Claude Code：代理编码的最佳实践](https://www.anthropic.com/engineering/claude-code-best-practices)（2025-04-18）
32. [“思考”工具：使克劳德能够在复杂的工具使用情况下停下来思考](https://www.anthropic.com/engineering/claude-think-tool)（2025-03-20）
33. [提高 SWE 工作台的标准 通过 Claude 3.5 Sonnet 进行验证](https://www.anthropic.com/engineering/swe-bench-sonnet)（2025-01-06）
